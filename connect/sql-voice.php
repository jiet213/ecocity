...
$sth = mysql_query("SELECT Date FROM voice WHERE  Sample='$samP' and Time='Night'");
$rows1 = array();
$rows1['name'] = 'Date';
...
$sth = mysql_query("SELECT {$samI} FROM voice WHERE Sample='$samP' and Time='Day'");
...
$sth = mysql_query("SELECT {$samI} FROM voice WHERE Sample='$samP' and Time='Night'");
//$property = mysql_fetch_field($sth1);//取得列的信息
$rows3 = array();
...
$sth = mysql_query("SELECT {$samI} FROM voice WHERE Sample='$samtP' and Time='Day'");
//$property = mysql_fetch_field($sth1);//取得列的信息
$rows4 = array();
...
$sth = mysql_query("SELECT {$samI} FROM voice WHERE Sample='$samtP' and Time='Night'");
//$property = mysql_fetch_field($sth1);//取得列的信息
$rows5 = array();
